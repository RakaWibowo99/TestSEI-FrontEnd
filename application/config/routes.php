...
*/
$route['default_controller'] = 'home'; // This will map the base URL to the 'home' controller
$route['home'] = 'home/index'; // This maps '/home' to the 'index' method of the 'home' controller
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
